...
#include "std_msgs/msg/float32_multi_array.hpp" //SWS_240331
...
using std_msgs::msg::Float32MultiArray; //SWS_240401
...
class TrajectoryAnalyzer
{
  ...
  using PublisherType2 = rclcpp::Publisher<Float32MultiArray>::SharedPtr; //SWS_240401
...
public:
  ...
  : node_(node), name_(sub_name)
  {
    ...
    const auto pub_name2 = sub_name + "/debug_info2"; //SWS_240401
    pub_ = node->create_publisher<TrajectoryDebugInfo>(pub_name, 1);
    pub2_ = node->create_publisher<Float32MultiArray>(pub_name2, 1); //SWS_240401
...
public:
  ...
  std::string name_;
  PublisherType pub_;
  PublisherType2 pub2_; //SWS_240401
  SubscriberType sub_;
