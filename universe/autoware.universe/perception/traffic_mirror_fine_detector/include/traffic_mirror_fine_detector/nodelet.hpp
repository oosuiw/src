...
{
class TrafficMirrorFineDetectorNodelet : public rclcpp::Node
{
  using TrafficMirrorRoi = tier4_perception_msgs::msg::TrafficMirrorRoi;
  using TrafficMirrorRoiArray = tier4_perception_msgs::msg::TrafficMirrorRoiArray;

public:
  explicit TrafficMirrorFineDetectorNodelet(const rclcpp::NodeOptions & options);
  void connectCb();
  /**
...
private:
  ...
  /**
   * @brief Read the label file to get class number and traffic_mirror class index of the model
   *
  ...
  message_filters::Subscriber<TrafficMirrorRoiArray> rough_roi_sub_;
  message_filters::Subscriber<TrafficMirrorRoiArray> expect_roi_sub_;
  std::mutex connect_mutex_;
  rclcpp::Publisher<TrafficMirrorRoiArray>::SharedPtr output_roi_pub_;
  rclcpp::Publisher<tier4_debug_msgs::msg::Float32Stamped>::SharedPtr exe_time_pub_;
  rclcpp::TimerBase::SharedPtr timer_;

  typedef message_filters::sync_policies::ExactTime<
    sensor_msgs::msg::Image, TrafficMirrorRoiArray, TrafficMirrorRoiArray>
    SyncPolicy;
...
};  // TrafficMirrorFineDetectorNodelet
