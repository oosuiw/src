...
LocalizationErrorMonitor::LocalizationErrorMonitor() : Node("localization_error_monitor")
{
  ...
  localization_accuracy_pub_ = this->create_publisher<std_msgs::msg::Float32MultiArray>("/localization_accuracy", 1); //HJK_240619
...
void LocalizationErrorMonitor::onOdom(nav_msgs::msg::Odometry::ConstSharedPtr input_msg)
{
  ...
  //HJK_240619 {
  localization_msg.data.push_back(ellipse_.long_radius);
  localization_msg.data.push_back(ellipse_.size_lateral_direction);
  localization_accuracy_pub_->publish(localization_msg);
  localization_msg.data.clear();
  //HJK_240619 }
