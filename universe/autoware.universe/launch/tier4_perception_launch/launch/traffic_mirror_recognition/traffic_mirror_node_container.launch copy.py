...
def generate_launch_description():
    ...
    add_launch_arg(
        ...
        os.path.join(mirror_fine_detector_share_dir, "data", "yolox_tmr.onnx"),
    )
    add_launch_arg(
        "fine_detector_label_path",
        os.path.join(mirror_fine_detector_share_dir, "data", "tmr_labels.txt"), #KMS_250407 #tlr_labels.txt
    )
    ...
    fine_detector_loader = LoadComposableNodes(
        composable_node_descriptions=[
            ComposableNode(
                ...
                plugin="traffic_light::TrafficMirrorFineDetectorNodelet",
