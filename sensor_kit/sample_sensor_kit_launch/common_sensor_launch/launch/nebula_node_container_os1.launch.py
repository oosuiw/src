...
def launch_setup(context, *args, **kwargs):
    ...
    #KMS_241012
    cropbox_parameters["min_x"] = -1.3 #vehicle_info["min_longitudinal_offset"]
    cropbox_parameters["max_x"] = 0.3 #vehicle_info["max_longitudinal_offset"]
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ...
                ("~/output/pointcloud", "/sensing/lidar/concatenated/pointcloud"), #HJK 241011 pointcloud
            ],
            extra_arguments=[{"use_intra_process_comms": LaunchConfiguration("use_intra_process")}],
        )
    )
